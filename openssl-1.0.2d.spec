...
%define CONFIG_FLAGS -DSSL_ALLOW_ADH --prefix=/usr/local/openssl --openssldir=%{openssldir}
...
%attr(0644,root,root) /usr/local/openssl/lib/pkgconfig/openssl.pc
...
ln -sf /usr/local/openssl/lib/* /usr/local/lib
ln -sf /usr/local/openssl/include/openssl /usr/local/include/openssl
%postun
ldconfig
